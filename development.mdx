---
title: "Development"
description: "Preview Vibedropper docs locally with Mintlify"
---

<Info>
  **Prerequisites**: Node.js 19 or higher, and a docs repo with a `docs.json` file (this repo).
</Info>

Use these steps to run the **documentation site** locally. To run the **Vibedropper app** itself, see [Quickstart](/quickstart).
